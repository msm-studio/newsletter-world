// Setup database for Newsletter World
// Runs schema on Supabase via Management API

const https = require('https');

const token = 'sbp_b154bea06861c881057b6cb8bafc8dc905f8b056';
const projectRef = 'bvnjiamypyvxtdpvnfea';
...
async function setup() {
  console.log('Setting up Newsletter World database...\n');
  ...
  // Step 2: Add unique constraint on levels
  await runSQL(`
    DO $$
    BEGIN
      IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'levels_name_theme_order_unique'
      ) THEN
        ALTER TABLE levels ADD CONSTRAINT levels_name_theme_order_unique
        UNIQUE (name, theme, order_index);
      END IF;
    END $$;
  `, 'Added unique constraint on levels');
  ...
  const levels = [
    {
      ...
      layout: JSON.stringify({
        background: { color: "#F4A460", layers: [{ type: "sky", color: "#87CEEB" }, { type: "dunes", color: "#DEB887", parallax: 0.3 }] },
        platforms: [
    ...
    },
    {
      ...
      unlocked: false,
      layout: JSON.stringify({
        background: { color: "#B0E0E6", layers: [{ type: "sky", color: "#87CEEB" }, { type: "mountains", color: "#E0F2F7", parallax: 0.3 }] },
        platforms: [
        ...
        collectibles: [
          { x: 350, y: 420 }, { x: 550, y: 330 }, { x: 730, y: 250 }, { x: 1070, y: 260 },
          { x: 1450, y: 280 }, { x: 1830, y: 300 }, { x: 2250, y: 320 }, { x: 2600, y: 160 },
          { x: 2930, y: 320 }, { x: 3330, y: 340 }, { x: 3680, y: 180 }, { x: 4010, y: 340 },
          { x: 4420, y: 360 }, { x: 4770, y: 200 }, { x: 5100, y: 360 }, { x: 5530, y: 380 }
        ],
        start: { x: 100, y: 450 },
    ...
    },
    {
      ...
      unlocked: false,
      layout: JSON.stringify({
        background: { color: "#2D5016", layers: [{ type: "sky", color: "#87CEEB" }, { type: "trees", color: "#1F3A12", parallax: 0.3 }] },
        platforms: [
        ...
        collectibles: [
          { x: 330, y: 430 }, { x: 500, y: 350 }, { x: 660, y: 270 }, { x: 810, y: 350 },
          { x: 1170, y: 340 }, { x: 1350, y: 250 }, { x: 1500, y: 330 }, { x: 1870, y: 330 },
          { x: 2050, y: 240 }, { x: 2210, y: 320 }, { x: 2610, y: 310 }, { x: 2780, y: 220 },
          { x: 2930, y: 300 }, { x: 3310, y: 300 }, { x: 3480, y: 210 }, { x: 3630, y: 290 },
          { x: 4000, y: 290 }, { x: 4170, y: 200 }, { x: 4320, y: 280 }, { x: 4700, y: 460 },
          { x: 4930, y: 380 }
        ],
        start: { x: 100, y: 450 },
    ...
    },
    {
      ...
      unlocked: false,
      layout: JSON.stringify({
        background: { color: "#87CEEB", layers: [{ type: "sky", color: "#87CEEB" }, { type: "ocean", color: "#4A90A4", parallax: 0.3 }] },
        platforms: [
        ...
        collectibles: [
          { x: 350, y: 440 }, { x: 540, y: 360 }, { x: 710, y: 280 }, { x: 860, y: 360 },
          { x: 1240, y: 350 }, { x: 1420, y: 260 }, { x: 1580, y: 340 }, { x: 1980, y: 340 },
          { x: 2160, y: 250 }, { x: 2310, y: 330 }, { x: 2700, y: 320 }, { x: 2870, y: 230 },
          { x: 3020, y: 310 }, { x: 3400, y: 310 }, { x: 3570, y: 220 }, { x: 3720, y: 300 },
          { x: 4090, y: 300 }, { x: 4260, y: 210 }, { x: 4410, y: 290 }, { x: 4790, y: 470 },
          { x: 5020, y: 390 }, { x: 5270, y: 470 }
        ],
        start: { x: 100, y: 450 },
    ...
    },
    {
      ...
      unlocked: false,
      layout: JSON.stringify({
        background: { color: "#8B7355", layers: [{ type: "sky", color: "#87CEEB" }, { type: "mountains", color: "#5D4E37", parallax: 0.3 }] },
        platforms: [
        ...
        collectibles: [
          { x: 330, y: 420 }, { x: 500, y: 330 }, { x: 650, y: 240 }, { x: 800, y: 150 },
          { x: 950, y: 230 }, { x: 1120, y: 320 }, { x: 1300, y: 230 }, { x: 1460, y: 140 },
          { x: 1610, y: 220 }, { x: 1780, y: 310 }, { x: 1970, y: 400 }, { x: 2170, y: 310 },
          { x: 2340, y: 220 }, { x: 2490, y: 130 }, { x: 2630, y: 210 }, { x: 2790, y: 300 },
          { x: 2970, y: 390 }, { x: 3160, y: 300 }, { x: 3330, y: 210 }, { x: 3480, y: 120 },
          { x: 3620, y: 200 }, { x: 3780, y: 290 }, { x: 3960, y: 380 }, { x: 4150, y: 470 },
          { x: 4360, y: 380 }, { x: 4540, y: 290 }
        ],
        start: { x: 100, y: 450 },
  ...
  for (const level of levels) {
    const escapedLayout = level.layout.replace(/'/g, "''");
    await runSQL(`
      INSERT INTO levels (name, theme, order_index, unlocked_by_default, layout)
      VALUES ('${level.name}', '${level.theme}', ${level.order_index}, ${level.unlocked}, '${escapedLayout}'::jsonb)
      ON CONFLICT (name, theme, order_index) DO UPDATE SET layout = EXCLUDED.layout;
    `, `Inserted level: ${level.name}`);
  }

  // Step 5: Create indexes
  await runSQL(`CREATE INDEX IF NOT EXISTS idx_leaderboard_level ON leaderboard(level_id);`, 'Created leaderboard level index');
  await runSQL(`CREATE INDEX IF NOT EXISTS idx_leaderboard_time ON leaderboard(completion_time);`, 'Created leaderboard time index');
  await runSQL(`CREATE INDEX IF NOT EXISTS idx_levels_order ON levels(order_index);`, 'Created levels order index');
